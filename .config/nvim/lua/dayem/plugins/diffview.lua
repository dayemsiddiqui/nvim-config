return {
        ...
        require("diffview").setup({
            ...
            keymaps = {
                ...
                view = {
                    ...
                    { "n", "<leader>gf", actions.focus_files, { desc = "Bring focus to the file panel" } },
    ...
    keys = {
        ...
        { "<leader>gD", function()
            local branch = vim.fn.input("Branch to diff against: ", "main")
            if branch ~= "" then
                vim.cmd("DiffviewOpen " .. branch)
            end
        end, desc = "Diff View with Branch" },
        ...
        { "<leader>gm", "<cmd>DiffviewOpen -m<cr>", desc = "Open Merge Tool" },
